...
export default function Services() {
  ...
  const ThisCard = ({ href, src, alt, title, desc, link, subtitle }) => {
    return (
      <div className="h-fit bg-transparent rounded-3xl shadow-xl transition-all">
        <div className="flex overflow-hidden justify-center items-center rounded-t-2xl bg-transparent">
          <Image
            src={src}
            className=" w-full"
            quality={100}
        ...
        <div className="flex flex-col h-full">
          <div className="py-6 lg:py-8 bg-white">
  ...
  const LogoFooter = ({ href, src, alt, title }) => {
    return (
      <Link href={href} target="_blank">
        <div className="flex px-2 py-2 items-center space-x-2 rounded-xl font-semibold bg-black hover:bg-gradient-to-r hover:from-[#FF4265] hover:to-[#ff423c] text-white transition-all">
